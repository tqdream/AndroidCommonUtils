 ...
 */
package tqdream.ok.good.WebView;
...
public class WebActivity extends Activity {
    ...
    private View createContentView() {
        ...
        mTitle.setPadding(DensityUtil.dip2px(this, 20), 0, DensityUtil.dip2px(this, 20), 0);
        LinearLayout.LayoutParams titleParams = new LinearLayout.LayoutParams(LinearLayout
                .LayoutParams.MATCH_PARENT, DensityUtil.dip2px(this, 45));
        ...
        LinearLayout.LayoutParams progressParams = new LinearLayout.LayoutParams(LinearLayout
                .LayoutParams.MATCH_PARENT, DensityUtil.dip2px(this, 3));
    ...
    private WebViewClient mWebViewClient = new WebViewClient() {
        ...
        public void onPageStarted(WebView view, String url, Bitmap favicon) {
            Log.v(TAG, "WebView Page Started");
        }

        @Override
        public void onPageFinished(WebView view, String url) {
            Log.v(TAG, "WebView Page Finished");
        }

        @Override
        public void onLoadResource(WebView view, String url) {
            Log.v(TAG, "WebView Load Resource");
        }
        ...
        public void onReceivedError(WebView view, int errorCode,
            ...
            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
                Log.e(TAG, String.format("ErrorCode:{%d}, ErrorMessage:{%s}", errorCode, description));
            }
        }
        ...
        public void onReceivedError(WebView view, WebResourceRequest request, WebResourceError error) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                Log.e(TAG, String.format("ErrorCode:{%d}, ErrorMessage:{%s}", error.getErrorCode(), error.getDescription()));
            }
        }
        ...
        public void onReceivedHttpError(WebView view, WebResourceRequest request, WebResourceResponse errorResponse) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                Log.e(TAG, String.format("HttpStatusCode:{%d}, HttpErrorMessage:{%s}", errorResponse.getStatusCode(), errorResponse
                        .getReasonPhrase()));
            }
        }
    };
