...
public class NoPreloadViewPager extends ViewGroup {
     ...
     * is fully in tqdream.base.base.widget.view and no animation is in progress.
     */
    ...
    void setCurrentItemInternal(int item, boolean smoothScroll, boolean always, int velocity) {
        ...
        if (item > (mCurItem + pageLimit) || item < (mCurItem - pageLimit)) {
            ...
            // glitches, we want to keep all current pages in the tqdream.base.base.widget.view
     ...
     * current page in the tqdream.base.base.widget.view hierarchy in an idle state. Defaults to 1.
     *
     ...
     * current page in the tqdream.base.base.widget.view hierarchy in an idle state. Pages beyond this
     ...
     * newly created tqdream.base.base.widget.view subtrees as the user pages back and forth.</p>
     *
    ...
    void populate() {
        ...
        // avoid trying to populate before we have restored our tqdream.base.base.widget.view hierarchy
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        // our tqdream.base.base.widget.view.  We can't really know what it is since we will be
    ...
    private void completeScroll() {
        ...
        if (needPopulate) {
            // Done with scroll, no longer want to cache tqdream.base.base.widget.view drawing.
            setScrollingCacheEnabled(false);
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                */
                ...
                if (canScroll(this, false, (int) dx, (int) x, (int) y)) {
                    // Nested tqdream.base.base.widget.view has scrollable area under this point. Let it be handled there.
     ...
     * with the touch scrolling of another tqdream.base.base.widget.view, while still letting the ViewPager
     ...
     * @param checkV Whether the tqdream.base.base.widget.view v passed should itself be checked for scrollability (true),
    ...
    public boolean dispatchKeyEvent(KeyEvent event) {
        // Let the focused tqdream.base.base.widget.view and/or our descendants get the key first
        return super.dispatchKeyEvent(event) || executeKeyEvent(event);
    }

    /**
     * You can call this function yourself to have the scroll tqdream.base.base.widget.view perform
     * scrolling from a key event, just as if the event had been dispatched to
     * it by the tqdream.base.base.widget.view hierarchy.
     *
