...
public class IOUtils {
    ...
    public static InputStream toBufferedInputStream(InputStream input) throws IOException {
        return tqdream.io.stream.ByteArrayOutputStream.toBufferedInputStream(input);
    }
    ...
    public static byte[] toByteArray(InputStream input) throws IOException {
        tqdream.io.stream.ByteArrayOutputStream output = new tqdream.io.stream.ByteArrayOutputStream();
        copy(input, output);
     ...
     * before using {@link tqdream.io.IOUtils#toByteArray(InputStream, int)} to read into the byte array.
     ...
     * @see tqdream.io.IOUtils#toByteArray(InputStream, int)
     * @since 2.1
     */
