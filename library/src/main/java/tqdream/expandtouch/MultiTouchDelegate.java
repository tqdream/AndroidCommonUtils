...
/**
 * 该扩展可以使一个ViewGroup中的子View也扩展相同的响应区域
 */
public class MultiTouchDelegate extends TouchDelegate {
    ...
    public MultiTouchDelegate(Rect bounds, View delegateView, ViewGroup parentView, int leftExpand, int rightExpand, int topExpand, int bottomExpand) {
