 ...
 * <li>{@link PackageUtils3#installNormal(Context, String)}</li>
 * <li>{@link PackageUtils3#installSilent(Context, String)}</li>
 * <li>{@link PackageUtils3#install(Context, String)}</li>
 * </ul>
 * <ul>
 * <strong>Uninstall package</strong>
 * <li>{@link PackageUtils3#uninstallNormal(Context, String)}</li>
 * <li>{@link PackageUtils3#uninstallSilent(Context, String)}</li>
 * <li>{@link PackageUtils3#uninstall(Context, String)}</li>
 * </ul>
 * <ul>
 * <strong>Is system application</strong>
 * <li>{@link PackageUtils3#isSystemApplication(Context)}</li>
 * <li>{@link PackageUtils3#isSystemApplication(Context, String)}</li>
 * <li>{@link PackageUtils3#isSystemApplication(PackageManager, String)}</li>
 * </ul>
 * <ul>
 * <strong>Others</strong>
 * <li>{@link PackageUtils3#getInstallLocation()} get system install location</li>
 * <li>{@link PackageUtils3#isTopActivity(Context, String)} whether the app whost
 * package's name is packageName is on the top of the stack</li>
 * <li>{@link PackageUtils3#startInstalledAppDetails(Context, String)} start
 * InstalledAppDetails Activity</li>
 * </ul>
 *
 * @author jingle1267@163.com
 */
public final class PackageUtils3 {
    ...
    public static final int install(Context context, String filePath) {
        if (PackageUtils3.isSystemApplication(context)
     ...
     * @param context
     * @param filePath file path of package
     * @return {@link PackageUtils3#INSTALL_SUCCEEDED} means install success,
     * other means failed. details see {@link PackageUtils3}
