...
public class ListUtils {
     ...
     * @param sourceList
     * @param entryList
     * @return the count of entries be added 被添加的元素个数
     */
     ...
     * @param <V>
     * @param sourceList
     * @return the count of entries be removed 移出的元素的个数
     */
    ...
    /**
     * @see {@link ArrayUtils2#getLast(Object[], Object, Object, boolean)} defaultValue is null, isCircle is true
     */
    @SuppressWarnings("unchecked")
    public static <V> V getLast(List<V> sourceList, V value) {
        return (sourceList == null) ? null : (V) ArrayUtils2.getLast(sourceList.toArray(), value, true);
    }

    /**
     * @see {@link ArrayUtils2#getNext(Object[], Object, Object, boolean)} defaultValue is null, isCircle is true
     */
    @SuppressWarnings("unchecked")
    public static <V> V getNext(List<V> sourceList, V value) {
        return (sourceList == null) ? null : (V) ArrayUtils2.getNext(sourceList.toArray(), value, true);
    }
