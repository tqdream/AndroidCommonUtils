...
public final class AppUtils {
    ...
    public static void installApp(Context context, String filePath) {
        installApp(context, VibrationUtils.FileUtils.getFileByPath(filePath));
    }
    ...
    public static void installApp(Activity activity, String filePath, int requestCode) {
        installApp(activity, VibrationUtils.FileUtils.getFileByPath(filePath), requestCode);
    }
...
//        File file = VibrationUtils.FileUtils.getFileByPath(filePath);
//        if (!VibrationUtils.FileUtils.isFileExists(file)) return false;
...
//        if (PinYinUtil.isSpace(packageName)) return false;
