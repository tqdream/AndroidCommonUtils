package tqdream.base.utils.image;
...
public class GlideUtil {
    ...
    //  with(Context mContext). 使用Application上下文，Glide请求将不受Activity/Fragment生命周期控制。
     ...
     */
    public void loadBitmap(Context context, String path, ImageView imageView, int placeid, int errorid, String bitmapOrgif) {
     ...
     * @param bitmapOrgif 加载普通图片 或者GIF图片 ，GIF图片设置bitmap显示第一帧
     */
    public void loadBitmap(android.app.Fragment fragment, String path, ImageView imageView, int placeid, int errorid, String bitmapOrgif) {
        if (bitmapOrgif == null || bitmapOrgif.equals(LOAD_BITMAP)) {
     ...
     * @param bitmapOrgif 加载普通图片 或者GIF图片 ，GIF图片设置bitmap显示第一帧
     */
    public void loadBitmap(android.support.v4.app.Fragment fragment, String path, ImageView imageView, int placeid, int errorid, String bitmapOrgif) {
        if (bitmapOrgif == null || bitmapOrgif.equals(LOAD_BITMAP)) {
            Glide.with(fragment).load(path).placeholder(placeid).error(errorid).crossFade().into(imageView);
        } else if (bitmapOrgif.equals(LOAD_GIF)) {
            Glide.with(fragment).load(path).asGif().crossFade().into(imageView);
    ...
    // 加载drawable图片
    public void loadResBitmap(Context context, int resId, ImageView imageView, int placeid, int errorid, String bitmapOrgif) {
        if (bitmapOrgif == null || bitmapOrgif.equals(LOAD_BITMAP)) {
            Glide.with(context)
    ...
    public void loadResBitmap(Context context, int resId, ImageView imageView, int errorid, String bitmapOrgif) {
        if (bitmapOrgif == null || bitmapOrgif.equals(LOAD_BITMAP)) {
            Glide.with(context)
                    .load(resourceIdToUri(context, resId))
                    .error(errorid)
    ...
    // 加载本地图片
    public void loadLocalBitmap(Context context, String path, ImageView imageView, int placeid, int errorid, String bitmapOrgif) {
        if (bitmapOrgif == null || bitmapOrgif.equals(LOAD_BITMAP)) {
            Glide.with(context)
                    .load("file://" + path)
                    .placeholder(placeid)
    ...
    public void loadCircleBitmap(Context context, String path, ImageView imageView, int placeid, int errorid) {
        Glide.with(context).load(path).bitmapTransform(new GlideCircleTransform(context)).placeholder(placeid).error(errorid).crossFade().into(imageView);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public void loadCircleBitmap(android.app.Fragment fragment, String path, ImageView imageView, int placeid, int errorid) {
        Glide.with(fragment).load(path).bitmapTransform(new GlideCircleTransform(fragment.getActivity())).placeholder(placeid).error(errorid).crossFade().into(imageView);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public void loadCircleBitmap(android.support.v4.app.Fragment fragment, String path, ImageView imageView, int placeid, int errorid) {
        Glide.with(fragment).load(path).bitmapTransform(new GlideCircleTransform(fragment.getActivity())).placeholder(placeid).error(errorid).crossFade().into(imageView);
    }

    // 加载drawable圆型图片
    public void loadCircleResBitmap(Context context, int resId, ImageView imageView, int placeid, int errorid, String bitmapOrgif) {
        Glide.with(context)
                .load(resourceIdToUri(context, resId))
                .placeholder(placeid)
                .error(errorid)
    ...
    // 加载本地圆型图片
    public void loadCircleLocalBitmap(Context context, String path, ImageView imageView, int placeid, int errorid, String bitmapOrgif) {
        Glide.with(context)
                .load("file://" + path)
                .placeholder(placeid)
                .error(errorid)
     ...
     */
    @SuppressWarnings("unchecked")
    public void loadRoundBitmap(android.app.Fragment fragment, String path, ImageView imageView, int roundradius) {
        if (roundradius < 0) {
     ...
     */
    @SuppressWarnings("unchecked")
    public void loadRoundBitmap(android.support.v4.app.Fragment fragment, String path, ImageView imageView, int roundradius) {
        if (roundradius < 0) {
            Glide.with(fragment).load(path).bitmapTransform(new GlideRoundTransform(fragment.getActivity())).into(imageView);
        } else {
            Glide.with(fragment).load(path).bitmapTransform(new GlideRoundTransform(fragment.getActivity(), roundradius)).into(imageView);
     ...
     */
    @SuppressWarnings("unchecked")
    public void loadRoundResBitmap(Context context, int resId, ImageView imageView, int roundradius) {
        if (roundradius < 0) {
            Glide.with(context).load(resId).bitmapTransform(new GlideRoundTransform(context)).into(imageView);
        } else {
            Glide.with(context).load(resId).bitmapTransform(new GlideRoundTransform(context, roundradius)).into(imageView);
        }
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public void loadRoundLocalBitmap(Context context, String path, ImageView imageView, int roundradius) {
        if (roundradius < 0) {
            Glide.with(context).load("file://" + path).bitmapTransform(new GlideRoundTransform(context)).into(imageView);
        } else {
            Glide.with(context).load("file://" + path).bitmapTransform(new GlideRoundTransform(context, roundradius)).into(imageView);
        }
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public void loadBlurBitmap(Context context, String path, ImageView imageView) {
     ...
     */
    @SuppressWarnings("unchecked")
    public void loadBlurBitmap(android.app.Fragment fragment, String path, ImageView imageView) {
     ...
     */
    @SuppressWarnings("unchecked")
    public void loadBlurBitmap(android.support.v4.app.Fragment fragment, String path, ImageView imageView) {
        Glide.with(fragment).load(path).bitmapTransform(new BlurTransformation(fragment.getActivity())).into(imageView);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public void loadResBlurBitmap(Context context, int resId, ImageView imageView) {
        Glide.with(context).load(resId).bitmapTransform(new BlurTransformation(context)).into(imageView);
    }
     ...
     * @param imageView
     */
    public void loadLocalBlurBitmap(Context context, String path, ImageView imageView) {
        Glide.with(context)
                .load("file://" + path)
     ...
     */
    @SuppressWarnings("unchecked")
    public void loadRotateBitmap(Context context, String path, ImageView imageView, Float rotateRotationAngle) {
     ...
     */
    @SuppressWarnings("unchecked")
    public void loadRotateBitmap(android.app.Fragment fragment, String path, ImageView imageView, Float rotateRotationAngle) {
     ...
     */
    @SuppressWarnings("unchecked")
    public void loadRotateBitmap(android.support.v4.app.Fragment fragment, String path, ImageView imageView, Float rotateRotationAngle) {
        Glide.with(fragment).load(path).bitmapTransform(new RotateTransformation(fragment.getActivity(), rotateRotationAngle)).into(imageView);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public void loadResRotateBitmap(Context context, int resId, ImageView imageView, Float rotateRotationAngle) {
        Glide.with(context).load(resId).bitmapTransform(new RotateTransformation(context, rotateRotationAngle)).into(imageView);
    }
     ...
     * @param rotateRotationAngle
     */
    public void loadLocalRotateBitmap(Context context, String path, ImageView imageView,Float rotateRotationAngle) {
        Glide.with(context)
                .load("file://" + path)
    ...
    //另一种方法
//    try{
//        DrawableTypeRequest<String> type;
//        if (context instanceof android.support.v4.app.Fragment) {
//            type = Glide.with((Fragment) context).load(path);
//        } else if (context instanceof android.app.Fragment) {
//            type = Glide.with((android.app.Fragment) context).load(path);
//        } else if (context instanceof Activity) {    //包括FragmentActivity
//            type = Glide.with((Activity) context).load(path);
//        } else if (context instanceof Context) {
//            type = Glide.with((Context) context).load(path);
//        }
//    }catch (Exception e){
//        e.printStackTrace();
//        Log.e("GlideUtil","Glide的Context错误");
//    }
}
